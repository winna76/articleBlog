...
class Controller{
	...
	public function jump($url,$info=NULL,$time=3){
		//先判断是立即跳转还是刷新跳转
		if(is_null($info)){
			//说明是立即跳转
			...
			<style type='text/css'>
				*{margin:0; padding:0;}
				div {width:390px; height:287px; border:1px #09C solid;
					position: absolute; left:50%; margin-left:-195px;top:10%;}
				div h2 {width:100%; height:30px; line-height:30px;
					background-color:#O9C; font-size:14px; color: #FFF;
					text-indent:10px;}
			...
			<div>
				<h2>提示信息</h2>
				<p>
					<strong>$info</strong><br/>页面在<span id="second">$time</span>秒后会自动跳转，或点击<a id="tiao" href="$url">立即跳转</a>
				</p>
			</div>
